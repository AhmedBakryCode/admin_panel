...
class TestsCubit extends Cubit<TestsState> {
  ...
  Future<void> loadTests() async {
    ...
    try {
      ...
      List<Map<String, dynamic>> tests = snapshot.docs.map((doc) => doc.data() as Map<String, dynamic>).toList();
  ...
  Future<void> addTest(String testName, String videoName, List<Map<String, dynamic>> questions) async {
    try {
